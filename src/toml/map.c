...
static void append_node(toml_map_t map, char const *key, toml_variant_t variant)
{
...
void toml_map_set_map(toml_map_t map, char const *key, toml_map_t value)
{
    append_node(map, key, toml_variant_create_map(value));
}

void toml_map_set_array(toml_map_t map, char const *key, toml_array_t value)
{
    append_node(map, key, toml_variant_create_array(value));
}

void toml_map_set_integer(toml_map_t map, char const *key, toml_integer_t value)
{
    append_node(map, key, toml_variant_create_integer(value));
}

void toml_map_set_float(toml_map_t map, char const *key, toml_float_t value)
{
    append_node(map, key, toml_variant_create_float(value));
}

void toml_map_set_boolean(toml_map_t map, char const *key, toml_boolean_t value)
{
    append_node(map, key, toml_variant_create_boolean(value));
}

void toml_map_set_string(toml_map_t map, char const *key, toml_string_t value)
{
